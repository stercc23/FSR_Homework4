function [t,EA,EAd] = fig_animate(tout,Xout,Uout,Xdout,Udout,Uext,p,prefix)
...
%     legend(h_x, 'x', 'y', 'z', 'x_d', 'y_d', 'z_d'); % Legenda aggiunta
% 
%     %%%%%%%%% velocity %%%%%%%%%
...
%     legend(h_dx, 'v_x', 'v_y', 'v_z', 'v_{xd}', 'v_{yd}', 'v_{zd}'); % Legenda aggiunta
% 
%     %%%%%%%%% Angular velocity %%%%%%%%% 
...
%     legend(h_w, 'ω_x', 'ω_y', 'ω_z', 'ω_{xd}', 'ω_{yd}', 'ω_{zd}'); % Legenda aggiunta
%     
%     %% control
...
%     legend(h_u, 'Fz_1', 'Fz_2', 'Fz_3', 'Fz_4', 'Fz_{1d}', 'Fz_{2d}', 'Fz_{3d}', 'Fz_{4d}'); % Legenda aggiunta
%     
    %% make movie
    if flag_movie
